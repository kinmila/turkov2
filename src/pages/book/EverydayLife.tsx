            ...
            <div className="space-y-3 bg-card/30 py-5 md:py-8 px-4 md:px-6 border-l border-primary/40">
              ...
              <div className="space-y-4">
                <p className="text-base md:text-lg leading-relaxed text-foreground/90">
                  Хочеш, я продовжу про те,<br />
                  як такі дії та простори <em>не «відривають» від життя,</em><br />
                  а <em>вплітаються у повсякденність так,<br />
                  що кожен день стає частиною глибинної присутності?</em>
                </p>
                <p className="text-base md:text-lg leading-relaxed text-foreground/90">
                  Це — останнє коло інтеграції:<br />
                  <em>втілення духу в матерії без втрати ясності.</em>
                </p>
              </div>
            </div>
