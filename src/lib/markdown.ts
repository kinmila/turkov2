...
export const loadChapterMarkdown = async (
  ...
  try {
    ...
    const chapterMap: Record<string, string> = {
      ...
      'space-security': '34',
      'power-security': '35',
      'three-levels-security': '36',
      'loss-death-chaos': '37',
      'ai-interaction': '38',
      'finance-world': '39',
      'not-becoming-function': '40',
      'competition-trade-price': '41',
      'unconscious-code': '42',
      'language-free-presence': '43',
      'world-perceiving-other': '44',
      'manifesto': '45',
      'not-clinging-form': '46',
      'not-losing-clarity': '47',
      'people-of-will': '48',
      'people-of-intellect': '49',
      'deadly-serious': '50',
      'ps': '51',
      'pps': '52',
    };
